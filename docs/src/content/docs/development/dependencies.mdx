...
|----------|---------|---------|
| `release.yml` | Tag push `v*` | GoReleaser build → GitHub Release + Docker images + Homebrew |
...
- **Docker**: Multi-arch images pushed to `ghcr.io/portainer/portainer-mcp`
- **Homebrew**: Formula published to `portainer/homebrew-tap`
...
| **Homebrew** | Binary distribution | `portainer/homebrew-tap` repo |
